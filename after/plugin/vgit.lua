...
vgit.setup({
    keymaps = {
        ...
        ['n <leader>gg'] = function() vgit.buffer_gutter_blame_preview() end,
        ['n <leader>glu'] = function() vgit.buffer_hunks_preview() end,
        ['n <leader>gls'] = function() vgit.project_hunks_staged_preview() end,
        ['n <leader>gd'] = function() vgit.project_diff_preview() end,
        ['n <leader>gq'] = function() vgit.project_hunks_qf() end,
